...
public class MultiTransferBuilderTest {
    ...
    public void testMultiTransferBuild() throws Exceptions.AddressException {
        TokenPayment[] payments = {
                TokenPayment.nonFungible(TokenIdentifier.fromString("ERDJAVA-38f249"),1L),
        ...
        String result = new MultiTransferBuilder()
                ...
                .build();
        assertEquals("MultiESDTNFTTransfer@0139472eff6886771a982f3083da5d421f24c29181e63888228dc81ca60d69e1@02@4552444a4156412d333866323439@01@01@4241522d633830643239@00@008ac7230489e80000", result);
    }
}
